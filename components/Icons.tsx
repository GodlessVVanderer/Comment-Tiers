...
export const LogoIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
    <path strokeLinecap="round" strokeLinejoin="round" d="M9.75 3.104v5.714a2.25 2.25 0 01-.659 1.591L5 14.5M9.75 3.104c-.251.023-.501.05-.75.082m.75-.082a24.301 24.301 0 014.5 0m0 0v5.714c0 .597.237 1.17.659 1.591L19.8 14.5M14.25 3.104c.251.023.501.05.75.082M19.8 14.5l-4.242 4.243a2.25 2.25 0 01-1.591.659v4.242M5 14.5c0-1.844 1.5-3.344 3.344-3.344h1.312c1.844 0 3.344 1.5 3.344 3.344s-1.5 3.344-3.344 3.344H8.344C6.5 17.844 5 16.344 5 14.5z" />
  </svg>
);
...
export const YoutubeIcon = (props: IconProps) => (
  <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 24 24" {...props}>
    <path d="M12.01 5.54a6.73 6.73 0 00-6.73 6.73 6.73 6.73 0 006.73 6.73 6.73 6.73 0 006.73-6.73c0-3.72-3.01-6.73-6.73-6.73zm0 12.21a5.48 5.48 0 01-5.48-5.48c0-3.02 2.46-5.48 5.48-5.48a5.48 5.48 0 015.48 5.48c0 3.02-2.46 5.48-5.48 5.48zm4.3-5.48l-6.07-3.23v6.46l6.07-3.23z" />
  </svg>
);
...
export const ChatBubbleIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193l-3.72 3.72a1.125 1.125 0 01-1.59 0l-3.72-3.72c-1.133-.093-1.98-1.057-1.98-2.193v-4.286c0-.97.616-1.813 1.5-2.097M16.5 7.5v-1.875a3.375 3.375 0 00-3.375-3.375h-1.5a3.375 3.375 0 00-3.375 3.375V7.5m6 0v2.25m-6-2.25v2.25m0 0v3m0-3h3m-3 0h-3" />
    </svg>
);
...
export const CoffeeIcon = (props: IconProps) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" {...props}>
        ...
        <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 013 3v3.75a3 3 0 01-3 3h-1.5" />
    </svg>
);
